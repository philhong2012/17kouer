...
import com.zdnst.common.infra.utils.StringUtils;
...
public class Page  implements java.io.Serializable {
	...
	protected int pageSize = 20; // 每页默认10条数据
	protected int currentPage = 1; // 当前页
	protected boolean isGetTotalPage = true; // 是否计算总页数
	...
	private List list;//返回结果集
	protected String pageStr; // 用于页面显示
	...
	public Page(int rows, int pageSize,boolean isGetTotalPage) {
		this.init(rows, pageSize,isGetTotalPage);
	}
	public Page() {
	 ...
	 * @param pageSize	分页数
	 */
	public Page(String currentPage,String pageSize,boolean isGetTotalPage){
		if (StringUtils.isNotEmpty(currentPage) && StringUtils.isNotEmpty(pageSize)) {
			this.setCurrentPage(StringUtils.toInt(currentPage));
			this.setPageSize(StringUtils.toInt(pageSize));
		}
	 ...
	 * @param pageSize	分页数
	 */
	public Page(String currentPage,String pageSize,String isGetTotalPage){
		if (StringUtils.isNotEmpty(currentPage) && StringUtils.isNotEmpty(pageSize)) {
			this.setCurrentPage(StringUtils.toInt(currentPage));
			this.setPageSize(StringUtils.toInt(pageSize));
		}
		if (StringUtils.COMMON_VALUE_1.equals(isGetTotalPage)){
			this.isGetTotalPage=true;
		}else{
			this.isGetTotalPage=false;
		}
	}
	...
	public void init(int rows, int pageSize,boolean isGetTotalPage) {
...
//		System.out.println(debug);
	...
	public void setIsGetTotalPage(boolean isGetTotalPage) {
		this.isGetTotalPage = isGetTotalPage;
	}
}
